...
function StopIt.OnAddOnLoaded(_,addOnName)
	...
	SCENE_MANAGER:GetScene('cadwellsAlmanac'):RemoveFragmentGroup(FRAGMENT_GROUP.FRAME_TARGET_STANDARD_RIGHT_PANEL_ORIGINAL)
...
FRAGMENT_GROUP =
{
    ...
    FRAME_TARGET_STANDARD_RIGHT_PANEL_ORIGINAL =
    {
